...
@authors: Cyril Bataillie, Tiffany Bec, Julie Lelong, Alain Soulignac
"""
...
dataList = [data_21dbm, data_24dbm, data_27dbm, data_30dbm]
dataNameList = ["data_21dbm", "data_24dbm", "data_27dbm", "data_30dbm"]

tagList = data_30dbm.Tagid.unique()

readRateList = []
associationRateList = []
associationRateAfterImprovementList = []
...
for data in dataList:
    ...
    associationRateList.append(associationRate)
    associationRateAfterImprovementList.append(associationRateAfterImprovement)
    
d = {'Power (db)':dataNameList, 'Read Rate':readRateList, 'Association Rate (before improvement)':associationRateList, 'Association Rate (AFTER improvement)':associationRateAfterImprovementList}
